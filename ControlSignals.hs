...
data CtlState a = CtlState
  {st_instr_fet,
   ...
   st_add,
   st_sub,
   st_mul0, st_mul1, st_mul2, -- the new states for multiply in task 2 are added here
   st_cmplt,
   st_cmpeq,
   st_cmpgt,
   st_trap0,
   ...
   st_jumpt0, st_jumpt1,
   st_jal0, st_jal1,
   st_loadxi0, st_loadxi1, st_loadxi2, st_loadxi3 -- the new states added for loadxi are added here
